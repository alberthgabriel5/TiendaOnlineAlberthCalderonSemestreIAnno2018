...
<article>
    ...
    <form action="?controlador=Product&accion=addProduct" enctype="multipart/form-data" method="POST">
        <div class="form-group col-lg-6" >
            ...
            <br> <br>  
            <input type="text" size="100" class="col-lg-12 input-lg" required name="descripcion" id="descripcion" value="" placeholder="Descripcion" />
            <br><br><br> 
            <div class="uploadBtn">
                <input id="fileImage0" class="btn btn-sm btn-default label-info bg-info" name="fileImage0"  required accept="image/x-png,image/gif,image/jpeg" type="file">
            </div>
            <br><br><br>
            <input class="col-lg-6 btn btn-success btn-lg" type="submit" value="Agregar" id="Agregar" name="Agregar" />
        </div>
        <div class="form-group col-lg-6">            
            <img id="img1" name="img1" class="col-lg-12 img-rounded" src='public/img/picDefault.jpg' alt="Imagen del Producto" />
